...
We point out that instance theory predictions for mean reaction time for a set of choice stimuli will be identical to the uncertainty, measured by H, for that set of choices. For example, this means that instnce theory is a process model of the hick-hyman law, and it inherits both the successess and failures of information theoretic interpretations of performance.
